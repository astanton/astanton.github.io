  ...
  (self["webpackChunkangular_cli_electron"] = self["webpackChunkangular_cli_electron"] || []).push([["main"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _AppComponent = /*#__PURE__*/function () {
        ...
        _createClass(_AppComponent, [{
          ...
          key: "calcluateGrossServiceSales",
          value: function calcluateGrossServiceSales() {
            var percentage = this.sharedDeduction * .01;
          ...
          key: "calculateFirstPercentCommission",
          value: function calculateFirstPercentCommission() {
            this.firstValue = this.remaining < 501 ? this.remaining : 500;
            this.firstPercent = this.firstValue * .50; // if we are in the negative then we hvae to set the remaining to 0;
          ...
          key: "calculateSecondPercentCommission",
          value: function calculateSecondPercentCommission() {
            this.secondValue = this.remaining < 1001 ? this.remaining : 1000;
            this.secondPercent = this.secondValue * .55; // if we are in the negative then we hvae to set the remaining to 0;
          ...
          key: "calculateThirdPercentCommission",
          value: function calculateThirdPercentCommission() {
            this.thirdValue = this.remaining < 1001 ? this.remaining : 1000;
            this.thirdPercent = this.thirdValue * .60; // if we are in the negative then we hvae to set the remaining to 0;
          ...
          key: "calculateFourthPercentCommission",
          value: function calculateFourthPercentCommission() {
            this.fourthValue = this.remaining;
            this.fourthPercent = this.fourthValue * .65; // if we are in the negative then we hvae to set the remaining to 0;
          ...
          key: "calculateTotalPay",
          value: function calculateTotalPay() {
      ...
      _AppComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 65,
        vars: 14,
        consts: [["color", "primary"], [1, "container"], [1, "input"], [1, "left"], [1, "label"], [1, "right"], [1, "value"], ["appearance", "fill"], ["matInput", "", "type", "number", 3, "ngModel", "ngModelChange", "keyup"], [1, "output"], ["matInput", "", 3, "ngModel", "ngModelChange", "keyup"], [1, "dollar-value"], ["matInput", "", 3, "ngModel", "ngModelChange"]],
        template: function AppComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function AppComponent_Template_input_ngModelChange_12_listener($event) {
              return ctx.grossServiceSales = $event;
            })("keyup", function AppComponent_Template_input_keyup_12_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function AppComponent_Template_input_ngModelChange_15_listener($event) {
              return ctx.sharedDeduction = $event;
            })("keyup", function AppComponent_Template_input_keyup_15_listener() {
              return ctx.calculateTotal();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function AppComponent_Template_input_ngModelChange_37_listener($event) {
              return ctx.percentGrossSales = $event;
            })("keyup", function AppComponent_Template_input_keyup_37_listener() {
              return ctx.calculateTotal();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function AppComponent_Template_input_ngModelChange_40_listener($event) {
              return ctx.totalAfterPercentDeducated = $event;
            })("keyup", function AppComponent_Template_input_keyup_40_listener() {
              return ctx.calculateTotal();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function AppComponent_Template_input_ngModelChange_43_listener($event) {
              return ctx.firstPercent = $event;
            })("keyup", function AppComponent_Template_input_keyup_43_listener() {
              return ctx.calculateTotal();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function AppComponent_Template_input_ngModelChange_48_listener($event) {
              return ctx.secondPercent = $event;
            })("keyup", function AppComponent_Template_input_keyup_48_listener() {
              return ctx.calculateTotal();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function AppComponent_Template_input_ngModelChange_53_listener($event) {
              return ctx.thirdPercent = $event;
            })("keyup", function AppComponent_Template_input_keyup_53_listener() {
              return ctx.calculateTotal();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function AppComponent_Template_input_ngModelChange_58_listener($event) {
              return ctx.fourthPercent = $event;
            })("keyup", function AppComponent_Template_input_keyup_58_listener() {
              return ctx.calculateTotal();
            });
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      _AppModule.ɵinj = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjector"]({
        providers: [],
        imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_3__.BrowserModule, _app_routing_module__WEBPACK_IMPORTED_MODULE_0__.AppRoutingModule, _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_4__.BrowserAnimationsModule, _angular_material_toolbar__WEBPACK_IMPORTED_MODULE_5__.MatToolbarModule, _angular_material_input__WEBPACK_IMPORTED_MODULE_6__.MatInputModule, _angular_material_form_field__WEBPACK_IMPORTED_MODULE_7__.MatFormFieldModule, _angular_material_divider__WEBPACK_IMPORTED_MODULE_8__.MatDividerModule, _angular_forms__WEBPACK_IMPORTED_MODULE_9__.FormsModule]]
      });
